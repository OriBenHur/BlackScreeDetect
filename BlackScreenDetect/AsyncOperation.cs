    ...
    public abstract class AsyncOperation
    {
        ...
        private bool IsDone
        {
            get
            {
                lock(this)
                {
                    return _completeFlag || _cancelAcknowledgedFlag || _failedFlag;
                }
            }
        }
        ...
        /// </summary>
        private ISynchronizeInvoke Target { get; }
        ...
        protected bool CancelRequested
        {
            get
            {
                lock(this) { return _cancelledFlag; }
            }
        }
        private bool _cancelledFlag;
        ...
        private bool HasCompleted
        {
            get
            {
                lock(this) { return _completeFlag; }
            }
        }
        ...
        private bool _cancelAcknowledgedFlag;
        ...
        private void InternalStart()
        {
            ...
            lock(this)
            {
                ...
                if (!_cancelAcknowledgedFlag && !_failedFlag)
                {
                    CompleteOperation();
                }
            }
